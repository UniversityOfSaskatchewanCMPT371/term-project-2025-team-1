        ...
        {/* Maybe fullscreen component stay displaying, but the container can chang visibility, so theres always that fullscreen button top left */}
            <Fullscreen flexDirection={"row"} distanceToCamera={0.8}>
                ...
                alignContent={"center"} justifyContent={"center"} flexDirection={"column"}>
                    ...
                    <Container width={"100%"} height={"70%"} alignContent={"center"} justifyContent={"center"}>
                        <Container width={"10%"} height={"5%"} backgroundOpacity={0.4}>

                        </Container>

                    {/* Body */}
                        <Container width={"20%"} height={"60%"} flexDirection={"column"} alignContent={"center"} justifyContent={"center"}>
                            <Container width={"100%"}
                                height={"100%"} 
                                borderWidth={2}
                                borderColor={"black"}
