...
export function TimeSeriesGraph({graph}:{graph: TimeSeriesGraphObject}): React.JSX.Element{
  ...
  */
      ...
      <>
        ...
        <Container height={"50%"} width={"100%"} justifyContent={"space-evenly"}>
          <Container width={"40%"} height={"30%"} backgroundColor={"gray"} backgroundOpacity={0.8}
            ...
            onClick={() => {graph.decrementYHeader(); UpdateGraph()}}>
              <Text fontWeight={"bold"}>&lt;</Text>
          </Container>

          <Container width={"40%"} height={"30%"} backgroundColor={"gray"} backgroundOpacity={0.8}
            justifyContent={"center"} hover={{backgroundOpacity: 0.95}} 
            onClick={() => {graph.incrementYHeader(); UpdateGraph()}}>
              <Text fontWeight={"bold"}>&gt;</Text>
          </Container>
        </Container>
      </>
  ...
  function GenerateSideBar(): React.JSX.Element{
    ...
    return(
      <>
        <Container width={"15%"} height={"100%"} backgroundColor={"skyblue"} flexDirection={"column"}>
