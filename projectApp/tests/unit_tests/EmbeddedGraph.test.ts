...
describe("Embedded Graph test", () => {
  ...
  test("vectors gets calculated correctly for X data set", () => {
    ...
    expect(points[0].getPosition()).toStrictEqual([1, 1, 1]);
    expect(points[1].getPosition()).toStrictEqual([2, 2, 2]);
    expect(points[2].getPosition()).toStrictEqual([3, 3, 3]);
    expect(points[3].getPosition()).toStrictEqual([4, 4, 4]);
    expect(points[4].getPosition()).toStrictEqual([5, 5, 5]);
    expect(points[5].getPosition()).toStrictEqual([6, 6, 6]);
    expect(points[6].getPosition()).toStrictEqual([7, 7, 7]);
    expect(points[7].getPosition()).toStrictEqual([8, 8, 8]);
    expect(points[8].getPosition()).toStrictEqual([9, 9, 9]);
    expect(points[9].getPosition()).toStrictEqual([10, 10, 10]);
  });
  ...
  test("vectors calculation for header row B", () => {
    ...
    graph.addPoints();
    const points = graph.getPoints3D();
    expect(points[0].getPosition()).toStrictEqual([2, 2, 2]);
    expect(points[1].getPosition()).toStrictEqual([4, 4, 4]);
    expect(points[2].getPosition()).toStrictEqual([6, 6, 6]);
    expect(points[3].getPosition()).toStrictEqual([8, 8, 8]);
    expect(points[4].getPosition()).toStrictEqual([10, 10, 10]);
    expect(points[5].getPosition()).toStrictEqual([12, 12, 12]);
    expect(points[6].getPosition()).toStrictEqual([14, 14, 14]);
    expect(points[7].getPosition()).toStrictEqual([16, 16, 16]);
    expect(points[8].getPosition()).toStrictEqual([18, 18, 18]);
    expect(points[9].getPosition()).toStrictEqual([20, 20, 20]);
  });
