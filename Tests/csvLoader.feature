Feature: csvLoader
  ...
  Background:
    ...
    And the user has a URL-based example CSV file with address "https://github.com/UniversityOfSaskatchewanCMPT371/term-project-2025-team-1/blob/main/csvTestFiles/test.csv"
